...
TEST(replacement, rand_empty)
{
    ...
    auto w = replacement::PageReferenceString{};
...
TEST(replacement, rand_single_page_single_reference)
{
    auto m = 4u;
    auto A = replacement::RAND(m);
    auto w = replacement::PageReferenceString{0u};
...
TEST(replacement, rand_single_page_multiple_references)
{
    auto m = 4u;
    auto A = replacement::RAND(m);
    auto w = replacement::PageReferenceString{0u, 0u, 0u, 0u};
    ASSERT_EQ(1u, replacement::cost(A, w));
}
...
TEST(replacement, rand_replacement)
{
    auto m = 4u;
    auto A = replacement::RAND(m);
    auto w = replacement::PageReferenceString{0u, 1u, 2u, 3u, 4u, 0u, 1u, 2u, 3u};
...
TEST(replacement, fifo_replacement)
{
    auto m = 4u;
    auto A = replacement::FIFO(m);
    auto w = replacement::PageReferenceString{0u, 1u, 0u, 2u, 0u, 3u, 0u, 4u, 0u};
...
{
    auto m = 4u;
    auto A = replacement::FIFO(m, std::vector<replacement::Page>{0u, 1u, 2u});
    auto w = replacement::PageReferenceString{0u, 1u, 2u, 3u, 0u, 1u, 2u, 3u};
    ASSERT_EQ(1u, replacement::cost(A, w));
}
...
{
    auto m = 4u;
    auto A = replacement::LRU(m, std::vector<replacement::Page>{0u, 1u, 2u});
    auto w = replacement::PageReferenceString{0u, 1u, 2u, 3u, 0u, 1u, 2u, 3u};
    ASSERT_EQ(1u, replacement::cost(A, w));
}
...
{
    {
        auto m = 4u;
        auto A = replacement::LRU(m, std::vector<replacement::Page>{0u, 1u, 2u});
        auto ws = std::vector<replacement::PageReferenceString>{
